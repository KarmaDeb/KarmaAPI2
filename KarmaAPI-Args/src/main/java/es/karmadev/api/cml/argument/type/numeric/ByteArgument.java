...
public class ByteArgument extends AbstractArgument<Byte> {
     ...
     */
    ByteArgument(final String key, final String description, final String help, final boolean isSwitch) {
        super(key, description, help, isSwitch, Byte.class);
    }
     ...
     */
    @Override
    public Optional<Byte> converse(final Object value) {
        Byte v = null;
        try {
            v = (Byte) value;
     ...
     */
    @Override
    public void mapArgument(final Object instance, final Byte value, final boolean safe) {
     ...
     * @return the argument
     */
    public static ByteArgument valueOf(final String key, final boolean isSwitch) {
     ...
     * @return the argument
     */
    public static ByteArgument valueOf(final String key, final String description, final boolean isSwitch) {
     ...
     * @return the argument
     */
    public static ByteArgument valueOf(final String key, final String description, final String help, final boolean isSwitch) {
        return new ByteArgument(key, description, help, isSwitch);
    }
}
