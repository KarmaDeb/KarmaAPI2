...
import es.karmadev.api.spigot.v1_8_R3.hologram.entity.craft.CraftHologramItem;
...
public class HologramItem extends EntityItem implements MinecraftItem {
    ...
    public void d(EntityHuman human) {
        ...
        if (line.getPickupHandler() != null && human instanceof EntityPlayer)
    ...
    public void setStack(final ItemStack stack) {
        ...
        if (nmsItem == null)
            nmsItem = new net.minecraft.server.v1_8_R3.ItemStack(Blocks.BEDROCK);
