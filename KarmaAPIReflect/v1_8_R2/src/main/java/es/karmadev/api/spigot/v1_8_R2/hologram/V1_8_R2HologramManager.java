...
public class V1_8_R2HologramManager extends HologramManager {
     ...
     *               manager
     */
    public V1_8_R2HologramManager(final KarmaPlugin plugin) {
        super(plugin);
        if (!SpigotServer.isMCP()) {
            try {
                ...
                ExceptionCollector.catchException(V1_8_R2HologramManager.class, ex);
            }
        }
