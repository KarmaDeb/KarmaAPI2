...
import es.karmadev.api.spigot.v1_8_R1.hologram.entity.HologramArmorStand;
import es.karmadev.api.spigot.v1_8_R1.hologram.entity.HologramItem;
import es.karmadev.api.spigot.v1_8_R1.hologram.entity.HologramSlime;
import es.karmadev.api.spigot.v1_8_R1.hologram.line.MinecraftHologramLine;
...
public class V1_8_R1HologramManager extends HologramManager {
     ...
     *               manager
     */
    public V1_8_R1HologramManager(final KarmaPlugin plugin) {
        super(plugin);
        if (!SpigotServer.isMCP()) {
            try {
                ...
                ExceptionCollector.catchException(V1_8_R1HologramManager.class, ex);
            }
        }
