...
import es.karmadev.api.spigot.v1_8_R3.hologram.entity.HologramArmorStand;
...
public class V1_8_R3HologramManager extends HologramManager {
     ...
     *               manager
     */
    public V1_8_R3HologramManager(final KarmaPlugin plugin) {
        super(plugin);
        if (!SpigotServer.isMCP()) {
            try {
                ...
                ExceptionCollector.catchException(V1_8_R3HologramManager.class, ex);
            }
        }
