...
public class SyncRayTrace implements RayTrace {
     ...
     */
    private SyncRayTrace(final Location source, final Location target) {
     ...
     */
    public static SyncRayTrace createRayTrace(final Entity source, final Entity target) {
        return new SyncRayTrace(source.getLocation(), target.getLocation());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Entity source, final Location target) {
        return new SyncRayTrace(source.getLocation(), target.clone());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Location source, final Entity target) {
        return new SyncRayTrace(source.clone(), target.getLocation());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Location source, final Location target) {
        return new SyncRayTrace(source.clone(), target.clone());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Entity source, final Block target) {
        return new SyncRayTrace(source.getLocation(), target.getLocation());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Block source, final Entity target) {
        return new SyncRayTrace(source.getLocation(), target.getLocation());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Location source, final Block target) {
        return new SyncRayTrace(source, target.getLocation());
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Block source, final Location target) {
        return new SyncRayTrace(source.getLocation(), target);
    }
     ...
     * @return the ray trace
     */
    public static SyncRayTrace createRayTrace(final Block source, final Block target) {
        return new SyncRayTrace(source.getLocation(), target.getLocation());
    }
}
