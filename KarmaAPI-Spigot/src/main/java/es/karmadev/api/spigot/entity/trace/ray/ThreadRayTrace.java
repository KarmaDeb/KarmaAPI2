...
/**
 * Thread-ed raytrace, meaning its made
 * on a separate thread
 */
public interface ThreadRayTrace {
     ...
     */
    TaskCompletor<RayTraceResult> trace(final TraceOption... options);
     ...
     * @return the trace task
     */
    TaskCompletor<RayTraceResult> trace(final double maxDistance, final TraceOption... options);
}
