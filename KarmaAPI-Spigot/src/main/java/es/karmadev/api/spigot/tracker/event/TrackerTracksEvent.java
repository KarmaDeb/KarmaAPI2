 ...
 * successfully track an entity
 */
public class TrackerTracksEvent extends EntityEvent {
     ...
     */
    public TrackerTracksEvent(final TrackerEntity tracker, final LivingEntity entity, final RayTraceResult rayTrace) {
        super(entity);
